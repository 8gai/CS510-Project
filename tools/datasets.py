...
dataset_dict = {
    "CS510": {
        "train": {
            ...
            "mask": "archive/mask.txt",
            "label": "archive/label.txt"
        }
    },
    'CS510_short': {
        "train": {
            ...
            "source_encoding": "UTF-8",
            "token": "None",
            "index": "archive/index_short.txt",
            "mask": "archive/mask_short.txt",
            "label": "archive/label_short.txt"
        }
    }
}
...
if __name__ == "__main__":
    ...
    print(output_label)
    '''
    trainset = TextDataSet('CS510', read_from_cache=True)
